					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-3">
										<input id="searchInput" name="search.account_like,realName_like" class="form-control" placeholder="角色名称" type="text" value=""/>
									</div>
									<div class="col-xs-3">
...
<js>
	<script type="text/javascript" src="${ctx}/static/assets/app/js/management/systemRoles.js"></script>
</js>