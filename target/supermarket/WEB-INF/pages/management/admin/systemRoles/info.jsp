        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <img id="avatar"
                     ...
                     alt="管理员" src="${ctx}/static/assets/lib/img/admin3.png"/>
                <div class="panel-body">
                    <table class="table">
                        <tbody>
                        <tr>
                            <td><h5>角色名称: <small>${role.name}</small></h5></td>
                        </tr>
                        <tr>
                            <td><h5>描述: <small>${role.description}</small></h5></td>
                        </tr>
                        <tr>
                            <td><h5>创建时间: <small>
                                <fmt:formatDate value="${role.createAt}" pattern="yyyy-MM-dd yyyy-MM-dd HH:mm:ss"/>
                            </small></h5></td>
                        </tr>
                        </tbody>
                    </table>
