            ...
            <div class="panel-body">
                <form id="systemAccount_form" class="form-horizontal" action="#" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="password">密码&nbsp;<span
                                style='color:#d15b47'>*</span></label>
                        <div class="col-xs-12 col-sm-5">
                            <input id="password" name="password" class="form-control" placeholder="请输入新密码" required
                                   type="text"
                                   />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-5">
                            <input id="repassword" name="repassword" class="form-control" placeholder="请输入新密码" type="text"
                                  />
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    $("#systemAccount_form").submit(function () {
        ...
        if(form.password.value.trim().length > 4 && form.password.value.trim().length < 16){
            if(form.repassword.value.trim() !=  form.password.value) {
                parent.layer.msg('密码不一致！', {icon: 5, time: 2000});
            }
            var params = {
                id: form.id.value,
            ...
            $.ajax({
                url: $.ctx + "/account/iframe/password",
                type: "post",
                data: params,
                dataType: "json",
                ...
                parent.layer.msg('请填写4~16位的密码', {icon: 5, time: 2000});
            }return false;
    })
</script>
