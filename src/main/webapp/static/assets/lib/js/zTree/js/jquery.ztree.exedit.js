(function($){
	...
	_zTreeTools = function(setting, zTreeTools) {
		...
		zTreeTools.setEditable = function(editable) {
			setting.create.enable = editable;
			return this.refresh();
		}
	},
	...
	_handler = {
		...
		onMousedownNode: function(eventMouseDown, _node) {
			...
			function _docMouseMove(event) {
				...
				if (root.dragFlag == 1) {
					...
					if (tmpTarget && tmpTarget.attr("id")!=targetSetting.treeId) {
						...
						isCopy = (event.ctrlKey && setting.create.drag.isMove && setting.create.drag.isCopy) || (!setting.create.drag.isMove && setting.create.drag.isCopy),
			...
			function _docMouseUp(event) {
				...
				var isCopy = (event.ctrlKey && setting.create.drag.isMove && setting.create.drag.isCopy) || (!setting.create.drag.isMove && setting.create.drag.isCopy);
	...
	_view = {
		addEditBtn: function(setting, node) {
			...
			editStr = "<span class='button edit' id='" + node.tId + consts.id.EDIT + "' title='"+tools.apply(setting.create.renameTitle, [setting.treeId, node], setting.create.renameTitle)+"' treeNode"+consts.id.EDIT+" style='display:none;'></span>";
			aObj.append(editStr);
		...
		addRemoveBtn: function(setting, node) {
			...
			var aObj = $("#" + node.tId + consts.id.A),
			removeStr = "<span class='button remove' id='" + node.tId + consts.id.REMOVE + "' title='"+tools.apply(setting.create.removeTitle, [setting.treeId, node], setting.create.removeTitle)+"' treeNode"+consts.id.REMOVE+" style='display:none;'></span>";
