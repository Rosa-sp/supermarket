        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <img id="avatar"
                     ...
                     alt="管理员" src="${account.headPic}" style="border-radius: 50%;
    ...
    height: 128px;
                ...
                <div class="panel-body">
                    <table class="table">
                        <tbody>
                        <tr>
                            <td><h5>账号: <small>${account.account}</small></h5></td>
                        </tr>
                        <tr>
                            <td><h5>姓名: <small>${account.realName}</small></h5></td>
                        </tr>
                        <tr>
                            <td><h5>状态: <small>${account.locked == false ? "未锁定" : "锁定"}</small></h5></td>
                        </tr>
                        <tr>
                            <td><h5>注册时间: <small>
                                <fmt:formatDate value="${account.createAt}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </small></h5></td>
                        </tr>
                        <tr>
                            <td><h5>上次登录时间: <small>
                                <fmt:formatDate value="${account.lastLoginAt}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </small></h5></td>
                        </tr>
                        </tbody>
                    </table>
